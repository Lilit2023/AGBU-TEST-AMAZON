...
#User Data
validUser = User("lilmankan@gmail.com", "amazonlilit2023@")
userWithInvalidPassword = ("lilmankan@gmail.com", "WrongPassword")
userWithInvalidUsername = ("invalidUsername", "WrongPassword")
